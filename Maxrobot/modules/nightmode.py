...
from Maxrobot import BOT_TOKEN
from Maxrobot.function.telethonbasics import is_admin
from Maxrobot.services.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
)
from Maxrobot.services.telethon import tbot
