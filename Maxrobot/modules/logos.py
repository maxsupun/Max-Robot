...
async def lego(event):
 ...
 try:
    ...
    img = Image.open(random.choice(Max-Robot/Maxrobot/resources/)
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 500
    fillcolor = "gold"
    shadowcolor = "blue"
    font = ImageFont.truetype("./Maxrobot/resources/Chopsic.otf", 50)
...
async def lego(event):
 ...
 try:
    text = event.pattern_match.group(1)
    img = Image.open(Max-Robot/Maxrobot/resources/)
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 500
    fillcolor = "gold"
...
async def lego(event):
 ...
 try:
    text = event.pattern_match.group(1)
    img = Image.open('./Maxrobot/resources/photo_2021-08-21_23-18-11.jpg')
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 500
    fillcolor = "gold"
