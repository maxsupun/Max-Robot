...
from Maxrobot import telethn as bot
from Maxrobot.modules.urluploader import download_file
from Maxrobot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @Maxrobotbot",
            )
        except Exception as e:
            traceback.print_exc()
